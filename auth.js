/* =====================================================
   App da Dra. Ingrid — login (Supabase Auth, e-mail e senha)
   A senha é criada por ela; nunca passa por aqui nem por mim.
   Base: auth.js do app-guia (fórmula app-um-so, peça 7: prazo em toda chamada).
   Quem é a dona NÃO é decidido aqui: o banco confere o e-mail (is_owner()).
   ===================================================== */
'use strict';

const AUTH_KEY = 'vetig_sessao_v1';
