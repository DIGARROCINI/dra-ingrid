...
const VER = 'vetig-0.10.0';
const ARQ = ['./', 'index.html', 'app.js', 'dados.js', 'icones.js', 'config.js', 'auth.js', 'nuvem.js', 'arquivos.js', 'simbolo.png', 'icon-192.png', 'manifest.webmanifest'];
